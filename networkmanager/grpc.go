...
func (w *NMWrapper) startGRPC() error {
	bind := BindAddr + ":4772"
...
func (w *NMWrapper) GetSmartMachineStatus(ctx context.Context,
...
func (w *NMWrapper) SetNetworkCredentials(ctx context.Context,
...
func (w *NMWrapper) SetSmartMachineCredentials(ctx context.Context,
...
func (w *NMWrapper) GetNetworkList(ctx context.Context,
